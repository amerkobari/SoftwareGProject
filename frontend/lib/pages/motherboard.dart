...
class MotherboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>( // Fetching Motherboard items from the database
        future: authController.fetchItems('Motherboard'), // Use fetchItems with 'Motherboard' category
              ...
              return Card(
                ...
                child: ListTile(
                  leading: item['images'] != null && item['images'].isNotEmpty
                      ...
                      : Image.asset(
                          'assets/icons/motherboard.png', // Default image if no image is available
                          width: 40,
                          height: 40,
                          fit: BoxFit.contain,
                        ),
