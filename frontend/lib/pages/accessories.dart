...
class AccessoriesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>( // Fetching Accessories items from the database
              ...
              return Card(
                ...
                child: ListTile(
                  leading: item['images'] != null && item['images'].isNotEmpty
                      ...
                      : Image.asset(
                          'assets/icons/accessory.png', // Default image if no image is available
                          width: 40,
                          height: 40,
                          fit: BoxFit.contain,
                        ),
