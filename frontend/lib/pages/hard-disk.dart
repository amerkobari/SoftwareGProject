...
class HardDiskPage extends StatefulWidget {
  const HardDiskPage({super.key});

  @override
  _HardDiskPageState createState() => _HardDiskPageState();
}

class _HardDiskPageState extends State<HardDiskPage> {
  ...
  Future<void> _fetchItems() async {
    try {
      final items = await authController.fetchItems('Hard Disk');
      setState(() {
        _items = items;
